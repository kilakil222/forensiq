...
var targets = []scanTarget{
	...
	{"emails", "from_addr", "", 0},
	{"emails", "to_addrs", "", 0},
	{"emails", "x_originating_ip", "", 0},
	{"emails", "body_text", "", 5000},
	{"email_urls", "url", "", 0},
	{"email_attachments", "sha256", "", 0},
	{"mem_cmdline", "cmdline", "", 0},
	{"registry_raw", "value_data", "", 0},
	{"linux_auth", "src_ip", "", 0},
	{"shell_history", "command", "", 0},
	{"anydesk_sessions", "client_alias", "", 0},
	{"anydesk_sessions", "anydesk_id", "", 0},
	{"anydesk_events", "message", "", 10000},
	{"wer_crashes", "app_name", "", 0},
	{"wer_crashes", "app_path", "", 0},
	{"wer_crashes", "fault_module", "", 0},
	{"srum_network_usage", "app_name", "", 0},
	{"srum_app_usage", "app_name", "", 0},
	{"bits_files", "remote_url", "", 0},
	{"bits_files", "local_path", "", 0},
	{"bits_jobs", "job_name", "", 0},
	{"typed_urls", "url", "", 0},
	{"run_mru", "command", "", 0},
	{"rdp_client_history", "server", "", 0},
	{"opensave_mru", "path", "", 0},
}
